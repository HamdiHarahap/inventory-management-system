<x-layout :title="$title">
    <section class="p-6 md:p-10">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Tambah Customer</h1>
            <p class="text-gray-500 mt-1">Isi data berikut untuk menambahkan customer baru.</p>
        </div>

        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <form method="POST" class="space-y-8" action="{{ route('customer.store') }}">
                @csrf
